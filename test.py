...
for idx, row in data.iterrows():
    ...
    result2 = translate.translate_text(Text=result1.get('TranslatedText'),
                                       SourceLanguageCode="en",
                                       TargetLanguageCode="zh")
    text_a = result2.get('TranslatedText')
    result1 = translate.translate_text(Text=row["text_b"], SourceLanguageCode="zh", TargetLanguageCode="en")
    result2 = translate.translate_text(Text=result1.get('TranslatedText'),
                                       SourceLanguageCode="en",
                                       TargetLanguageCode="zh")
